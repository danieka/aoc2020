(ns aoc-2020.2-password.core-test
  (:require [clojure.test :refer :all]
            [aoc-2020.2-password.core :as core]))

(def s1 "1-3 a: abcde
1-3 b: cdefg
2-9 c: ccccccccc")

(def input1 "1-7 q: qqqqxvqrkbqqztlqlzq
1-3 q: cqbm
...
(deftest count-passwords (is (= (core/sled-rental-checker s1) 2)))
(deftest count-passwords-tobbogan (is (= (core/tobbogan-checker s1) 1)))

(deftest parse-int (is (= (core/parse-int "4") 4)))
